...
public:
    ...
    void set(std::string stateSet, AnimationState state, float strength = 0.f);
...
private:
    ...
    std::map<AnimationState, std::pair<bool, float>> animationStates;
    std::map<CollisionState, std::pair<bool, float>> collisionStates;
};