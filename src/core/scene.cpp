...
void Scene::sceneInput(std::string control)
{
    ...
    {
        uiLayer.getElement("__inputNote")->setAnimation(game->getAssetManager()->getUIAnimationData("test4"));
    ...
    {
        uiLayer.getElement("__inputNote")->setAnimation(game->getAssetManager()->getUIAnimationData("test3"));
